// ─────────────────────────────────────────────────────────────────────────────
//  ProjectBomTab — Bill of Materials for a PROJECT, organised UNDER the scope.
//
//  The project analog of components/Leads/LeadBomTab.js. Materials are grouped
//  into sections — one per technical-scope line (project_phases parent phase),
//  plus a "General / Unassigned" section — and a material added under a section
//  links to that scope line (project_bom.scope_item_id → project_phases.id).
//
...
export default function ProjectBomTab({ projectUniqueId, project, currentUser, permissions, showSuccess, showError }) {
